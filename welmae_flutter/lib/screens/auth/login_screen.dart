...
class _LoginScreenState extends State<LoginScreen>
  ...
  // Velmae Brand Colors - matching design specifications
  static const Color velmaePrimary = Color(0xFF2563EB); // Blue-600
  static const Color velmaeSecondary = Color(0xFF10B981); // Emerald-500
  static const Color velmaeAccent = Color(0xFFEF4444); // Red-500
    ...
    if (digitsOnly.length >= 1) {
      ...
      if (digitsOnly.length > 1) {
        ...
        if (phoneDigits.startsWith('0')) {
          phoneDigits = phoneDigits.substring(1); // Remove leading 0
        }
  ...
  void _handleLogin() async {
    ...
    if (mounted) {
      // Go directly to OTP verification for login
      Navigator.pushNamed(
        context,
        '/otp-verification',
        arguments: {
  ...
  Widget _buildLoginButton() {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: _isPhoneValid ? _handleLogin : null,
          borderRadius: BorderRadius.circular(16),
          child: Center(
            child: _isLoading
                ? const SizedBox(
